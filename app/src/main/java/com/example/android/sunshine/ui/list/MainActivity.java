...
public class MainActivity extends LifecycleActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFactory = InjectorUtils.provideMainActivityViewModelFactory(this);
        mMainActivityViewModel = ViewModelProviders.of(this, mFactory).get(MainActivityViewModel.class);

        mMainActivityViewModel.getForecast().observe(this, weatherEntries -> {
            mForecastAdapter.swapForecast(weatherEntries);
            if(mPosition == RecyclerView.NO_POSITION) {mPosition = 1;}
